...
\begin{minted}{haskell}
  ...
  foldlList f d []    = d
  foldlList f d (h:t) = f h (foldlList f d t)
\end{minted}
\texttt{foldlNat} i \texttt{foldlList} mogą być przy pomocy kodowania Scotta zapisane jako
\begin{align*}
  \mathrm{foldlNat}  &\equiv \lambda f\,x\,n.\ n\,x\,(\lambda n.\ (foldNat\ f\ x\ n))\\
  \mathrm{foldlList} &\equiv \lambda f\,d\,x_s.\ x_s\, d\,(\lambda t.\ f\,h\,(foldList\ f\,d\,t))
\end{align*}
...
\end{align*}
Wyrażenia będące skutkiem konsekwentnej aplikacji Succ do Zero w literaturze popularnie nazywa się \emph{liczebnikami Churcha}. Porównując je do kodowania Scotta widzimy, że różnica polega na aplikowaniu do kontynuacji termu \(n\,f\,x\).

\subsubsection{Ogólny schemat kodowania Scotta}
