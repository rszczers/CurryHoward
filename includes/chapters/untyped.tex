...
\end{align*}
Wówczas funkcję \texttt{if} możemy reprezentować wyrażeniem \(if\equiv\lambda x.\,x\). W ogólnym przypadku, mając nastepującą definicję ADT:
\begin{minted}{haskell}
