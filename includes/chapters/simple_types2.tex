...
\begin{lemat}\label{def:sn_lemat1}
...
\begin{lemat}\label{def:sn_lemat2}
  Załóżmy, że:
  \begin{enumerate}[label=(\alph*)]
    \setlength\itemsep{0em}
...
\begin{dowod}
  ...
  \qed
\end{dowod}
\begin{lemat}\label{def:sn_lemat3}
  Załóżmy, że:
  \begin{enumerate}[label=(\alph*)]
    \setlength\itemsep{0em}
...
\begin{dowod}
  ...
  \begin{enumerate}[label=(\alph*)]
    \setlength\itemsep{0em}
    \item Jeśli \(\tau\) jest zmienną typową, to \(\llbracket \tau \rrbracket=\mathrm{SN}\). Wobec tego problem sprowadza się do Lematu \ref{def:sn_lemat2}.  
  ...
  \begin{enumerate}[label=(\alph*)]
    ...
    \end{align} 
      ...
      \begin{align*}
        ...
        \right )
      \end{align*}
      Ustalmy \(N_0\in\llbracket \sigma \rrbracket\). Wówczas z cześci \ref{def:l1_a} Lematu \ref{def:sn_lemat1} \(N_0\in\mathrm{SN}\). Wobec tego z Lematu \ref{def:sn_lemat3} wnioskujemy, że:
      \begin{align}
