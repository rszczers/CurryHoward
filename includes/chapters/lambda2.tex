...
W rozdziale tym przedstawimy tzw. rachunek \(\lambda\) drugiego rzędu w stylu Churcha. System ten wprowadzony został równolegle przez J.-Y. Girarda i J. C. Reynoldsa jako System F i w literaturze szerzej znany jest pod tą właśnie nazwą. Formalizuje on pojęcie polimorfizmu parametrycznego znanego z języków programowania.
