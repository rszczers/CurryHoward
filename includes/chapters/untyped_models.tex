...
\end{align*}
Fakt ten wymaga dowodu; szczegółowe uzasadnienia można znaleźć w \cite[Tw. 15.10(a)]{Hindley:2008:LCI:1388400}.
...
\((\lambda x. M)\), \((\lambda x. N)\in\mathbf{\Lambda}\) indukują częściowe aplikacje działania \(\bullet\)
...
Zgodnie z \eqref{eq:valuation-replace} możemy przepisać warunek \ref{def:lambda-interpret-6} do następującej równoważnej postaci
  \begin{align}
    ...
    \end{align}  
Własność \ref{eq:weak-extensional} w literaturze nazywa się niekiedy warunkiem \emph{słabej ekstensjonalności}.
