...
Wówczas  dla  wszystkich  \(d\in D\)  zbiór  \(\{\varphi(d)\  |\ 
  ...
  \Psi_\Phi(\bigsqcup X)&= \bigsqcup \Phi (\bigsqcup X)\\
                        ...
                        = \bigsqcup \Psi_\Phi(X).
          \end{align*}
        \item \(\Phi\) jest ograniczony w \([D\to D']\). Istotnie, przypuśćmy, że dla dowolnego \(f\in[D\to D']\) istnieje \(g\in\Phi\) taki, że \(f\preceq g\). Wówczas w szczególnosci \(\Psi_\Phi \preceq g\) i stąd również
          \[
